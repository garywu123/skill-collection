...
|---|---|---|
| Discovery notes | Current understanding of purpose, workflow, users, context, and critical unknowns | Interview transcripts, decision history, or approved product requirements |
...
3. Approved roadmap entry and, when present, its current feature specification.
...
When delivering a feature, read its one roadmap entry and applicable product
requirements. Read `spec.md` only when that optional detailed artifact exists.
Do not absorb later-feature scope merely because the roadmap describes it.
